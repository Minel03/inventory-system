...
@section('content')
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-bold text-gray-900">Edit Stock Movement</h1>
            <a href="{{ route('stock-movements.show', $stockMovement) }}"
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('stock-movements.update', $stockMovement) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="Adjustment"
                                    {{ old('type', $stockMovement->type) == 'Adjustment' ? 'selected' : '' }}>Adjustment
                                </option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="text" name="reference_no" id="reference_no"
                                value="{{ old('reference_no', $stockMovement->reference_no) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="date" id="date"
                                value="{{ old('date', $stockMovement->date->format('Y-m-d')) }}" required
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantity" id="quantity"
                                value="{{ old('quantity', $stockMovement->quantity) }}" min="1" required
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="unit_cost" id="unit_cost"
                                    value="{{ old('unit_cost', $stockMovement->unit_cost) }}" step="0.01" min="0"
                            ...
                            <select name="supplier_id" id="supplier_id"
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}"
                                        {{ old('supplier_id', $stockMovement->supplier_id) == $supplier->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="expiry_date" id="expiry_date"
                                value="{{ old('expiry_date', $stockMovement->expiry_date?->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="destination" id="destination"
                                value="{{ old('destination', $stockMovement->destination) }}"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="reason" id="reason"
                                value="{{ old('reason', $stockMovement->reason) }}"
                        ...
                        <div id="adjustment_field"
                            style="display: {{ old('type', $stockMovement->type) === 'Adjustment' ? 'block' : 'none' }};">
                            ...
                            <input type="number" name="adjustment_diff" id="adjustment_diff"
                                value="{{ old('adjustment_diff', $stockMovement->adjustment_diff) }}"
