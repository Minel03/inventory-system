                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('description')  @enderror">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="unit_measure" id="unit_measure" required
                                ...
                                <option value="pcs"
                                    {{ old('unit_measure', $product->unit_measure) == 'pcs' ? 'selected' : '' }}>Pieces
                                </option>
                                <option value="box"
                                    {{ old('unit_measure', $product->unit_measure) == 'box' ? 'selected' : '' }}>Box
                                </option>
                                <option value="kg"
                                    {{ old('unit_measure', $product->unit_measure) == 'kg' ? 'selected' : '' }}>Kilogram
                                </option>
                                <option value="L"
                                    {{ old('unit_measure', $product->unit_measure) == 'L' ? 'selected' : '' }}>Liter
                                </option>
                                <option value="m"
                                    {{ old('unit_measure', $product->unit_measure) == 'm' ? 'selected' : '' }}>Meter
                                </option>
                                <option value="dozen"
                                    {{ old('unit_measure', $product->unit_measure) == 'dozen' ? 'selected' : '' }}>Dozen
                                </option>
                            </select>
                            @error('unit_measure')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="vat_included" id="vat_included" value="1"
                                {{ old('vat_included', $product->vat_included) ? 'checked' : '' }}
